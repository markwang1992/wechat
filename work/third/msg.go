...
func (r *Client) GetGroupMsgListV2(req *GetGroupMsgListV2Request) (*GetGroupMsgListV2Response, error) {
	...
	if response, err = util.PostJSON(fmt.Sprintf(GetGroupMsgListV2URL, r.AccessToken), req); err != nil {
		return nil, err
	}
...
func (r *Client) GroupWelcomeTemplateEdit(req *GroupWelcomeTemplateEditRequest) error {
	...
	if response, err = util.PostJSON(fmt.Sprintf(GroupWelcomeTemplateEditURL, r.AccessToken), req); err != nil {
		return err
	}
...
func (r *Client) GroupWelcomeTemplateGet(req *GroupWelcomeTemplateGetRequest) (*GroupWelcomeTemplateGetResponse, error) {
	...
	if response, err = util.PostJSON(fmt.Sprintf(GroupWelcomeTemplateGetURL, r.AccessToken), req); err != nil {
		return nil, err
	}
...
func (r *Client) GroupWelcomeTemplateDel(req *GroupWelcomeTemplateDelRequest) error {
	...
	if response, err = util.PostJSON(fmt.Sprintf(GroupWelcomeTemplateDelURL, r.AccessToken), req); err != nil {
		return err
	}
